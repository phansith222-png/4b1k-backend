...
const postsData = [
  { content: "รอกดบัตรคอนเสิร์ตพี่นนท์ไม่ไหวแล้ววว", userId: 3, artistId: 1 },
  { content: "ใครมีบัตร Bodyslam โซน A ปล่อยบ้างครับ ทักแชทที", userId: 5, artistId: 6 },
  { content: "The Weeknd มาไทยรอบนี้จัดเต็มแน่!", userId: 4, artistId: 16 },
  { content: "เพลงใหม่ MILLI คือดีย์มากแม่", userId: 6, artistId: 12 },
  { content: "อิงค์ วรันธร น่ารักมากก งานเมื่อวาน", userId: 3, artistId: 2 }
];
